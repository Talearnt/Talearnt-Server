...
import com.talearnt.user.entity.QFindPasswrodUrl;
...
public class UserQueryRepository {
     ...
     * */
    public Optional<UserFindResDTO> findUserIdAndCreatedAt(String phone){
        QUser user = QUser.user;
        QUserFindResDTO userFindIdResDTO = new QUserFindResDTO(user.userId, user.registeredAt);
        return Optional.ofNullable(
                factory
