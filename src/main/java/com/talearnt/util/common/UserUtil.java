...
public class UserUtil {
    ...
    public static String makeRandomNickName(){
        ...
        List<String> adj = Arrays.asList(
                ...
                "정확한", "온화한", "강한 의지의", "협력적인", "명쾌한", "명석한", "순수한", "활기찬", "적응력 있는",
                "도전적인", "신중한", "경쾌한", "전진하는", "낙관적인", "성실한", "끊임없는", "능동적인", "사려 깊은",
                "영감을 주는", "발전하는", "긍정의", "중심을 지키는", "다양한", "용맹한", "성취 지향의", "현실적인", "도움을 주는",
        ...
        return adj.get(0)+" "+names.get(1)+"의 "+ new Random().nextInt(100000 - 1000 + 1) + 1000 +"번째 "+title.get(2);
    }
}
