...
public class ExchangeSearchCondition {
    ...
    @Builder
    public ExchangeSearchCondition(List<String> giveTalents, List<String> receiveTalents, String order, String duration, String requiredBadge, String status, String page, String size, String lastNo) {
